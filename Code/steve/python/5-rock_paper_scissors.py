...
#print(f'Computer chose {computer_rps}.')


# play the game
def play_rps(computer_rps):
    choice = rps()
    if choice == computer_rps:
        print('You tied!')
    elif choice == 'paper' and computer_rps == 'rock':
        print('You won, paper covers rock!')
    elif choice == 'paper' and computer_rps == 'scissors':
        print('You lost, scissors cuts paper!')
    elif choice == 'rock' and computer_rps == 'paper':
        print('You lost, paper covers rock!')
    elif choice == 'rock' and computer_rps == 'scissors':
        print('You won, rock crushes scissors!')
    elif choice == 'scissors' and computer_rps == 'rock':
