...
# here lies my broken attempt at solving this solo
#    # for mental processing sake: lets pretend the converted data would be
#    # [[6,9],[14, 17]]
#    # realistically I dont need to calculate anything other than the distance between the lowest peak and valley between them then mutliply it by the index gap of the two peaks 
#    # mental equation would be [ ((lowest_peak_value - valley_value) * (highest_peak_index - lowest_peak_index)) / 2 ] this would return the volume of water in the peak/valley combo 
